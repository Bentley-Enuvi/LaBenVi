...
namespace LaBenVi_OrderAPI.Controllers
{
    [ApiController]
    [Route("api/order")]
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(LaBenViDbContext context,
        ...
        public async Task<ResponseDto> CreateOrder([FromBody] CartDto cartDto)
        {
            try
            {
                ...
                orderHeaderDto.Status = Static_Details.Status_Pending;
        ...
        public async Task<ResponseDto> ValidateStripeSession([FromBody] int orderHeaderId)
        {
            try
            {
                ...
                if (paymentIntent.Status == "succeeded")
                {
                    ...
                    orderHeader.Status = Static_Details.Status_Approved;
                    _context.SaveChanges();
                    ...
                    //await _messageService.Send(message, attachment);
                    _response.Result = _mapper.Map<OrderHeaderDto>(orderHeader);
                }
        ...
        public async Task<ResponseDto> UpdateOrderStatus(int orderId, [FromBody] string newStatus)
        {
            try
            {
                ...
                if (orderHeader != null)
                {
                    if (newStatus == Static_Details.Status_Cancelled)
                    {
                        //we will give refund
