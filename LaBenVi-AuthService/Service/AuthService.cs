...
namespace LaBenVi_AuthService.Service
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(LaBenViDbContext context, IJwtTokenGenerator jwtTokenGenerator,
        ...
        public async Task<string> Register(RegRequestDto registrationRequestDto)
        {
            AppUser user = new()
            {
